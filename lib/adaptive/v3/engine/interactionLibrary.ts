...
export function buildFormatInstruction(params: {
  ...
  lines.push(`PREFERENCIA DEL ESTUDIANTE: ${
    preference === 'quick_test'
      ? 'EVALUACIONES RÁPIDAS — Prefiere opciones, completar, relacionar. NO escribir largo.'
...
• fill_blank — Completar espacio (CON banco de palabras)
  ...
  Schema: { "interactionType": "fill_blank", "prompt": "completa", "data": { "type": "fill_blank", "template": "Los ___ fueron fundados en ___", "correctAnswers": ["Falcons", "1965"], "bank": ["Falcons", "Eagles", "1965", "1970"] } }
...
`
  ...
  if (preference === 'quick_test') {
    ...
    lines.push(`SOLO usa formatos RÁPIDOS de la lista de arriba.`)
