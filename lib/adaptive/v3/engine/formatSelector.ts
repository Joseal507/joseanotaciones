      ...
      return `Genera una pregunta de completar espacio. Formato:
{
  ...
  "data": {
    "type": "fill_blank",
    "template": "El proceso comienza con ___",
      ...
      return `Completar con banco de opciones. Formato:
{
  ...
  "data": {
    ...
    "template": "El proceso comienza con ___",
    "bank": ["la observación", "la conclusión", "la revisión", "la aplicación"],
    "correctAnswers": ["la observación"]
  }
}`
      ...
      return `Genera un ejercicio de ORDENAR. Los ítems se muestran desordenados y el estudiante los ordena. Necesitas 3-5 elementos. Formato:
{
  ...
  "data": {
    "type": "ordering",
    "items": ["Evento posterior", "Evento inicial", "Evento intermedio"],
    "correctOrder": [1, 2, 0]
  }
}`
