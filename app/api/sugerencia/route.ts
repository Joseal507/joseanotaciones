    ...
    await transporter.sendMail({
      ...
      html: `
        <div style="font-family: -apple-system, sans-serif; max-width: 500px; margin: 0 auto; background: #0d0d1a; color: #fff; border-radius: 16px; overflow: hidden;">
          <div style="background: linear-gradient(135deg, var(--gold), var(--red)); padding: 20px; text-align: center;">
          ...
          <div style="padding: 24px;">
            ...
            <div style="background: #1a1a2e; border-left: 3px solid var(--gold); padding: 16px; border-radius: 0 8px 8px 0; margin-bottom: 16px;">
