        ...
        <>
          <header style={{ background: 'var(--bg-card)', borderBottom: '3px solid var(--gold)', padding: '0 40px', position: 'sticky', top: 0, zIndex: 100, display: 'flex', justifyContent: 'space-between', alignItems: 'center', height: '68px' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
              {loggedIn ? (
                <>
                  <button onClick={() => setShowBuscador(true)} style={{ padding: '8px 14px', borderRadius: '8px', border: '2px solid var(--border-color)', background: 'transparent', color: 'var(--text-muted)', fontSize: '13px', fontWeight: 700, cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '6px' }}>🔍 <span style={{ fontSize: '11px', background: 'var(--bg-secondary)', padding: '2px 6px', borderRadius: '4px' }}>⌘K</span></button>
                  <button onClick={() => window.location.href = '/horario'} style={{ padding: '8px 16px', borderRadius: '8px', border: '2px solid var(--gold)', background: 'transparent', color: 'var(--gold)', fontSize: '13px', fontWeight: 700, cursor: 'pointer' }}>🗓️ {tr('horario')}</button>
                  <button onClick={() => window.location.href = '/comunidad'} style={{ padding: '8px 16px', borderRadius: '8px', border: '2px solid #34d399', background: 'transparent', color: '#34d399', fontSize: '13px', fontWeight: 700, cursor: 'pointer' }}>🌍 Comunidad</button>
                  <button onClick={() => window.location.href = '/partners'} style={{ padding: '8px 16px', borderRadius: '8px', border: '2px solid #38bdf8', background: 'transparent', color: '#38bdf8', fontSize: '13px', fontWeight: 700, cursor: 'pointer' }}>👥 Partners</button>
                  <button onClick={() => window.location.href = '/chat'} style={{ padding: '8px 16px', borderRadius: '8px', border: '2px solid var(--pink)', background: 'transparent', color: 'var(--pink)', fontSize: '13px', fontWeight: 700, cursor: 'pointer' }}>🤖 JeffreyBot</button>
                  <button onClick={() => window.location.href = '/agenda'} style={{ padding: '8px 16px', borderRadius: '8px', border: '2px solid var(--blue)', background: 'transparent', color: 'var(--blue)', fontSize: '13px', fontWeight: 700, cursor: 'pointer' }}>📅 {tr('agenda')}</button>
                  <button onClick={() => window.location.href = '/materias'} style={{ padding: '8px 16px', borderRadius: '8px', border: 'none', background: 'var(--gold)', color: '#000', fontSize: '13px', fontWeight: 800, cursor: 'pointer' }}>📚 {tr('materias')}</button>
