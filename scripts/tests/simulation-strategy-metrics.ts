...
const reteachingSeparatesFailureEpisodes = measureStrategyChangesAfterRepeatedFailure([
  turn(1, 'incorrect', 'retrieve'),
  turn(2, 'correct', 'address_misconception', 'none'),
  turn(3, 'incorrect', 'retrieve'),
  turn(4, 'correct', 'retrieve'),
])
assert.deepEqual(
  reteachingSeparatesFailureEpisodes,
  { opportunities: 0, changes: 0 },
  'una intervención docente separa episodios; dos fallos a ambos lados no forman una racha',
)
