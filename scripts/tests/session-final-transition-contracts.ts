...
const complete:SessionTransitionState={currentStepIndex:11,currentEvaluationBlock:{id:'final',completed:true},currentQuestionIndex:2,unansweredNormalQuestions:0,pendingRecoveries:0,activeRecovery:false,completedEvaluationBlocks:4,totalEvaluationBlocks:4,totalTeachingSteps:12,sessionKind:'learning',sessionCompletionResult:{isSessionComplete:true,objectiveCoverageRatio:1}}
...
assert.deepEqual(deriveNextSessionAction({...complete,pendingRecoveries:1}),{type:'show_next_recovery'})
