...
export default function Toolbar({
  ...
  // Botón base
  const Btn = ({
    children, onClick, active, title, accent, w,
  }: {
    ...
    return (
      <button
        ...
        style={{
          ...
          boxShadow: active ? `0 1px 4px ${color}25, inset 0 1px 0 ${color}15` : 'none',
          whiteSpace: 'nowrap',
    ...
    <div style={{ userSelect: 'none' }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          height: '2px',
          background: `linear-gradient(90deg, transparent, ${temaColor}88, ${temaColor}, ${temaColor}88, transparent)`,
          opacity: 0.6,
        }} />
        ...
        <div style={{ display: 'flex', gap: '2px', alignItems: 'center' }}>
          <button
            ...
            style={{
              ...
              background: herramientaActiva === 'texto'
                ? `linear-gradient(135deg, ${temaColor}33, ${temaColor}11)`
          ...
          <button
            onClick={() => onHerramienta('seleccion')}
            title="Seleccionar trazos"
            style={{
              height: '32px',
              padding: '0 10px',
              borderRadius: '8px',
        ...
        <div style={{ display: 'flex', gap: '2px' }}>
          {[
            ...
            {
              id: 'lapiz' as Herramienta,
              icon: <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M17 3a2.828 2.828 0 114 4L7.5 20.5 2 22l1.5-5.5L17 3z"/></svg>,
              label: '✏️',
              color: '#a3e635',
            },
            {
              id: 'marcador' as Herramienta,
              icon: <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M3 22v-3l11-11"/><path d="M11.5 5.5l7 7"/><path d="M14 3l3 3-9 9-3-3 9-9z" fill="currentColor" fillOpacity="0.2"/></svg>,
              label: '🖊️',
              color: '#facc15',
            },
            {
              id: 'borrador' as Herramienta,
              icon: <svg width="17" height="12" viewBox="0 0 28 20" fill="none" stroke="currentColor" strokeWidth="1.5"><rect x="1" y="2" width="26" height="16" rx="3"/><rect x="1" y="2" width="9" height="16" rx="3" fill="rgba(255,255,255,0.15)"/><line x1="10" y1="2" x2="10" y2="18" strokeOpacity="0.4"/></svg>,
              label: '⬜',
              color: '#94a3b8',
            },
          ].map(({ id, icon, color }) => {
            ...
            return (
              <button
                ...
                onMouseEnter={(e: any) => {
                  if (!active) { e.currentTarget.style.background = 'rgba(255,255,255,0.08)'; e.currentTarget.style.color = color; }
                }}
                onMouseLeave={(e: any) => {
          ...
          {[
            {
              fn: onInsertImagen,
              label: 'Imagen',
              icon: <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><path d="M21 15l-5-5L5 21"/></svg>,
              color: '#38bdf8',
            },
            {
              fn: onInsertDibujo,
              label: 'Lienzo',
              icon: <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="2" y="2" width="20" height="20" rx="3"/><path d="M7 14c1-3 3-5 5-5s4 2 5 5"/></svg>,
              color: '#a78bfa',
            },
            {
              fn: insertLatex,
      ...
      <div style={{
        ...
        {/* FUENTE */}
        <select
          onChange={e => onExecCmd('fontName', e.target.value)}
          style={{
        ...
        <select
          ...
          style={{
            height: '26px', width: '60px', padding: '0 4px',
            borderRadius: '6px',
            border: '1.5px solid #e2e8f0',
            background: 'white',
            color: '#374151',
        ...
        >
          {[{ val: '1', l: '10' }, { val: '2', l: '12' }, { val: '3', l: '14' }, { val: '4', l: '16' }, { val: '5', l: '20' }, { val: '6', l: '28' }, { val: '7', l: '36' }]
            .map(s => <option key={s.val} value={s.val}>{s.l}px</option>)}
        </select>
        ...
        {/* BOLD / ITALIC / etc */}
        {[
          { cmd: 'bold',          label: 'B',  style: { fontWeight: 900, fontSize: '13px' } },
          { cmd: 'italic',        label: 'I',  style: { fontStyle: 'italic', fontWeight: 600, fontSize: '13px' } },
          { cmd: 'underline',     label: 'U',  style: { textDecoration: 'underline', fontWeight: 600, fontSize: '13px' } },
          { cmd: 'strikeThrough', label: 'S',  style: { textDecoration: 'line-through', fontWeight: 600, fontSize: '13px' } },
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '5px' }}>
          <label style={{ display: 'flex', alignItems: 'center', gap: '2px', cursor: 'pointer' }} title="Color del texto">
            ...
            <input type="color" defaultValue="#000000" onChange={e => onExecCmd('foreColor', e.target.value)}
              style={{ width: '18px', height: '18px', borderRadius: '4px', border: '1.5px solid #e2e8f0', cursor: 'pointer', padding: 0 }} />
          </label>
          <label style={{ display: 'flex', alignItems: 'center', gap: '2px', cursor: 'pointer' }} title="Resaltar texto">
            <span style={{ fontSize: '12px' }}>🖊</span>
            <input type="color" defaultValue="#fef08a" onChange={e => onExecCmd('hiliteColor', e.target.value)}
              style={{ width: '18px', height: '18px', borderRadius: '4px', border: '1.5px solid #e2e8f0', cursor: 'pointer', padding: 0 }} />
          </label>
        </div>
      </div>
