...
function checkAnswer(q: Question, userAnswer: any): boolean {
  ...
  if (q.type === 'multi_select') {
    ...
    const ca = [...(q.correctAnswers || [])].sort();
...
export default function QuizPage({
  ...
  // ── Carga de PDF — igual que FlashcardsPage, reactivo al material activo ──
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* PDF lado izquierdo — multi-material igual que FlashcardsPage */}
        <AnimatePresence>
    ...
    return (
      <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
        <input
          ...
          onKeyDown={e => {
            if (e.key === 'Enter' && !isLocked && userAnswer) e.stopPropagation();
          }}
          style={{
            padding: '16px 18px',
            borderRadius: 14,
            border: `2px solid ${isLocked ? (checkAnswer(question, userAnswer) ? '#4caf50' : '#f44336') : 'rgba(0,0,0,0.15)'}`,
            background: isLocked
