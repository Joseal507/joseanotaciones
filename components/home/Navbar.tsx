        ...
        <div onClick={() => onSetScreen('home')} style={{ display: 'flex', alignItems: 'center', gap: '10px', cursor: 'pointer' }}>
          ...
          <div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
              <span className="brand-studyal" style={{ fontSize: '22px', fontWeight: 900 }}>
                <span className="brand-study" style={{ fontSize: '85%', color: 'var(--text-primary)' }}>Study</span><span className="brand-al"><span style={{ color: '#ef4444' }}>A</span><span style={{ color: 'var(--text-primary)' }}>L</span></span>
              </span>
              <BetaBadge size="sm" />
            </div>
