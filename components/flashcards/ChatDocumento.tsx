  ...
  const enviar = async () => {
    ...
    try {
      ...
      setMensajes((prev) => [
        ...
        {
          role: 'assistant',
          content: idioma === 'en' ? '❌ Connection error.' : '❌ Error al conectar.',
        },
      ]);
    } finally {
      setCargando(false);
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <input
            ...
            style={{
              ...
              padding: '12px 16px',
              borderRadius: '12px',
              border: `2px solid ${input ? temaColor : 'var(--border-color)'}`,
          ...
          <button
            ...
            style={{
              ...
              borderRadius: '12px',
              border: 'none',
              background: input.trim() && !cargando ? temaColor : 'var(--bg-card2)',
        ...
        >
          {idioma === 'en'
            ? 'AlciBot only responds based on the document content'
            : 'AlciBot solo responde basándose en el contenido del documento'}
        </p>
      </div>
