        ...
        {tabActivo === 'stats' && (
          <div>
            ...
            <div style={{
              ...
              {[
                ...
                >
                  ...
                  <div style={{
                    fontFamily: HAND, fontSize: isMobile ? 12 : 14, fontWeight: 700,
            ...
            <div style={{ display: 'flex', gap: 12, marginTop: 22, flexWrap: 'wrap' }}>
              <PrimaryBtn onClick={() => window.location.href = '/materias'} color="var(--gold)">
                📚 {tr('irAEstudiar')}
              </PrimaryBtn>
              <SecondaryBtn onClick={() => window.location.href = '/chat'} color="var(--pink)">
                🤖 {tr('hablarChapBot')}
              </SecondaryBtn>
