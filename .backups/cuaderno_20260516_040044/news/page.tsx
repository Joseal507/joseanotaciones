      ...
      <div style={{ maxWidth: 1280, margin: '0 auto' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 24, paddingBottom: 16, borderBottom: '4px double var(--text-primary)' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: 8, padding: '6px 12px', borderTop: '2px solid var(--text-primary)', borderBottom: '1px solid var(--text-primary)', fontFamily: SERIF, fontSize: 12, color: 'var(--text-muted)', fontStyle: 'italic', flexWrap: 'wrap', gap: 8 }}>
            ...
            <span style={{ fontFamily: HAND, fontSize: 18, color: 'var(--gold)' }}>~ Noticias oficiales ~</span>
        ...
        {isAdmin && showForm && (
          <div style={{
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
              ...
              <textarea value={descripcion} onChange={e => setDescripcion(e.target.value)} placeholder="Descripción corta (resumen)" rows={2} style={{ ...inputStyle, fontFamily: SERIF, resize: 'vertical' }} />
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10 }}>
                ...
                <label style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '10px 14px', borderRadius: 8, border: '2px solid var(--border-color)', background: 'var(--bg-secondary)', fontFamily: HAND, fontSize: 16, fontWeight: 700, color: 'var(--text-primary)', cursor: 'pointer' }}>
                  <input type="checkbox" checked={destacada} onChange={e => setDestacada(e.target.checked)} style={{ width: 18, height: 18 }} />
                  ⭐ Destacada (principal)
                </label>
              </div>
              ...
              <textarea value={contenido} onChange={e => setContenido(e.target.value)} placeholder="Contenido completo (opcional, se muestra al abrir la noticia)" rows={6} style={{ ...inputStyle, fontFamily: SERIF, resize: 'vertical' }} />
        ...
        {showSecret && (
          <div onClick={() => setShowSecret(false)} style={{
            ...
            <div onClick={e => e.stopPropagation()} style={{
              ...
              {secretError && (
                <p style={{ fontFamily: HAND, fontSize: 15, color: '#dc2626', fontStyle: 'italic', textAlign: 'center', margin: '0 0 10px' }}>
              ...
              {principal && (
                ...
                >
                  ...
                  <div style={{ padding: '18px 22px', position: 'relative' }}>
                    ...
                    {isAdmin && (
                      <button onClick={(e) => { e.stopPropagation(); handleDelete(principal.id); }} style={delBtn}>🗑️</button>
                    )}
                  </div>
                </article>
              )}
                  ...
                  {secundarias.map(n => (
                    ...
                    >
                      ...
                      <div style={{ padding: '12px 14px', position: 'relative' }}>
                        ...
                        {isAdmin && (
                          <button onClick={(e) => { e.stopPropagation(); handleDelete(n.id); }} style={delBtn}>🗑️</button>
                        )}
                      </div>
                    </article>
                  ))}
                  ...
                  {restantes.map((n, i) => (
                    ...
                    >
                      ...
                      <div style={{ padding: '12px 16px' }}>
                        ...
                        <div style={{ marginTop: 8, paddingTop: 6, borderTop: '1px dashed var(--border-color)', fontFamily: HAND, fontSize: 12, color: 'var(--text-faint)', fontStyle: 'italic', display: 'flex', justifyContent: 'space-between' }}>
                          <span>✍️ {n.autor}</span>
