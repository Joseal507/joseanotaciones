  ...
  return (
    <>
          ...
          <div style={{
            ...
            {enviado ? (
              <div style={{ textAlign: 'center', padding: '20px 0' }}>
                ...
                <p style={{
                  fontFamily: HAND, fontSize: 22, color: 'var(--gold)',
      ...
      <footer style={{
        ...
        {/* línea de "página rasgada" arriba */}
        ...
        <div style={{
          ...
          <div style={{
            ...
            {/* Brand */}
            <div style={{ maxWidth: 280, transform: 'rotate(-1deg)' }}>
            ...
            <div style={{ display: 'flex', gap: 40, flexWrap: 'wrap' }}>
              ...
              <div style={{ ['--accent' as any]: 'var(--gold)' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                  {[
                    ...
                    <a key={link.href} href={link.href} className="nb-footer-link">
                      {link.label}
                    </a>
                  ))}
                </div>
              ...
              <div>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                  <button onClick={() => setShowSugerencia(true)}
                    ...
                    onMouseEnter={(e: any) => e.currentTarget.style.transform = 'translateX(4px) rotate(-1deg)'}
          ...
          <div style={{
            ...
            <p style={{
              ...
              {idioma === 'en' ? 'empowering' : 'impulsando'}
              <span style={{ color: 'var(--red)', margin: '0 4px', fontSize: 18 }}>✨</span>
              {idioma === 'en' ? 'students' : 'estudiantes'}
            </p>
          </div>
        </div>
      </footer>
